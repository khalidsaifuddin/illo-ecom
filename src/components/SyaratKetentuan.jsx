						...
						<div className="container">
							<div className="row">
                                <div className="col-md-6 col-sm-6 col-text-center d-align-center">
									<h2 className="title"><span> Syarat dan Ketentuan</span></h2>
								</div>
								<div className="col-md-6 col-sm-6 col-text-center">
									<nav aria-label="breadcrumb" className="blog-bradcrumb ">
										<ol className="breadcrumb bg-transparent mb-0">
											<li className="breadcrumb-item"><a href="/">Beranda</a></li>
											<li className="breadcrumb-item"><a href="/syarat-ketentuan">Syarat dan Ketentuan</a></li>
										</ol>
									</nav>
								</div>
							</div>
...
export default (connect(null, mapDispatchToProps)(SyaratKetentuan));
