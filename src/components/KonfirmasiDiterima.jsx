...
class KonfirmasiDiterima extends React.Component {
    ...
    KonfirmasiDiterima = () => {
        ...
        this.setState({
            ...
            this.props.simpanKonfirmasiDiterima({
                ...
                this.setState({
                    ...
                    tampil_alert: true,
                    warna_alert: 'green',
                    teks_alert: 'Transaksi berhasil dikonfirmasi!'
                },()=>{
                    setTimeout(() => {
						...
						<div className="container">
							<div className="row">
								<div className="col-md-6 col-sm-6 col-text-center d-align-center">
									<h2 className="title"><span>Konfirmasi Penerimaan Barang</span></h2>
								</div>
								<div className="col-md-6 col-sm-6 col-text-center">
									<nav aria-label="breadcrumb" className="blog-bradcrumb ">
										<ol className="breadcrumb bg-transparent mb-0">
											...
											<li className="breadcrumb-item"><a>Konfirmasi Penerimaan Barang</a></li>
										</ol>
									</nav>
								</div>
							</div>
							...
							<div className="row">
								<div className="col-md-12 col-lg-12 blog-sec">
                                    ...
                                    <div className="card card20" style={{border:(!JSON.parse(localStorage.getItem('user')).alamat_pengguna || JSON.parse(localStorage.getItem('user')).alamat_pengguna.length < 1 ? '1px solid red' : '1px solid #ccc')}}>
                                        <h3>Apakah Anda yakin barang dari transaksi ini telah diterima?</h3>
                                        ...
                                        <br/>
                                        <div>
                                            <button className="btn card20" style={{marginLeft:'4px', background:'green', color:'white'}} onClick={this.KonfirmasiDiterima}>
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        ...
        simpanKonfirmasiDiterima: Actions.simpanKonfirmasiDiterima
    }, dispatch);
}

export default (connect(null, mapDispatchToProps)(KonfirmasiDiterima));
